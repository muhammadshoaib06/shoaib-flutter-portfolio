...
export const es: Translations = {
  ...
  header: {
    ...
    title: 'Desarrollador de apps móviles | Desarrollador Flutter Senior',
    tagline:
  ...
  projects: {
    ...
    descriptions: {
      ...
      'Find My Filmmaker':
        'Find My Filmmaker conecta clientes con cineastas de todo el mundo — directores, editores, cinematógrafos y más. Los cineastas muestran portafolios y se hacen descubrir; los clientes exploran talento verificado, filtran por ubicación y rol, y colaboran con mensajería en tiempo real. Cambia entre modos cineasta y cliente desde una sola cuenta.',
      ...
      'Home Interior Exterior Design':
        'Home Design AI transforma interiores, exteriores, cocinas y jardines con herramientas de diseño con IA. Elige entre 70+ estilos y 30+ tipos de habitaciones, planifica distribuciones, convierte bocetos en renders y guarda o comparte diseños — para propietarios, diseñadores y aficionados al bricolaje.',
      Plodyo:
        'Plodyo es una app de narración con IA para niños que ayuda a padres, educadores y organizaciones a crear historias personalizadas con texto, ilustraciones, audiolibros y video en muchos idiomas. Creada con Flutter y Supabase, incluye registro por roles (padre / educador / organización), generación de historias y videos, biblioteca, suscripciones y notificaciones push para trabajos de contenido de larga duración.',
      Invogen:
