  ...
  projects: {
    ...
    descriptions: {
      ...
      'Islam Simplified: Learn & Grow':
        'Islam Simplified: Learn & Grow 是一款面向教育的学习应用，适合任何对伊斯兰教感兴趣的人，包括初学者与探索信仰的非穆斯林。它提供结构清晰的文章、教学视频、完整的《古兰经》翻译体验、常见问题与关键伊斯兰术语词汇表。学习者可按自己的节奏学习、保存收藏，并根据兴趣获得个性化推荐。应用将核心学习资源汇集在清晰、现代的界面中，让理解伊斯兰教更易上手。',
      ...
      'Find My Filmmaker':
        'Find My Filmmaker 连接客户与全球电影人 — 导演、剪辑师、摄影师等。电影人展示作品集并获得发现；客户浏览认证人才，按地点与角色筛选，并通过实时消息协作。同一账户可在电影人与客户模式间无缝切换。',
      ...
      'Home Interior Exterior Design':
        'Home Design AI 用 AI 设计工具改造室内、室外、厨房与花园。从 70 多种风格与 30 多种房间类型中选择，规划布局，草图转渲染，保存或分享方案 — 面向房主、设计师与 DIY 爱好者。',
      Plodyo:
